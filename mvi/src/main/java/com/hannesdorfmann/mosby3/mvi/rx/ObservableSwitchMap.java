...
public final class ObservableSwitchMap<T, R> extends Observable<R>
  ...
  @Override public ObservableSource<T> source() {
    return source;
  }

  @Override public void subscribeActual(Observer<? super R> t) {
  ...
  static final class SwitchMapObserver<T, R> extends AtomicInteger
    ...
    final AtomicReference<SwitchMapInnerObserver<T, R>> active =
        new AtomicReference<SwitchMapInnerObserver<T, R>>();
    ...
    @Override public void onNext(T t) {
      ...
      SwitchMapInnerObserver<T, R> nextInner =
          new SwitchMapInnerObserver<T, R>(this, c, bufferSize);
    ...
    @SuppressWarnings("unchecked") void disposeInner() {
  ...
  static final class SwitchMapInnerObserver<T, R> extends AtomicReference<Disposable>
    ...
    @Override public void onNext(R t) {
