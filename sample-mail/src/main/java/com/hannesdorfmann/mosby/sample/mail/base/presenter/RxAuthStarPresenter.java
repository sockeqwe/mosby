 ...
 */
public class RxAuthStarPresenter<V extends AuthStarView<M>, M> extends RxAuthPresenter<V, M> {

  @Inject public RxAuthStarPresenter(MailProvider mailProvider, EventBus eventBus) {
