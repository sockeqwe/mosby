 ...
 */
public class ContainerMviLifecycleFragment
    extends MviFragment<LifecycleTestView, LifecycleTestPresenter> implements LifecycleTestView {

  private static final String TAG = "ChildFragmentTag";
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    View view = inflater.inflate(R.layout.fragment_child_mvi_container, container, false);
    if (savedInstanceState == null) {
      getChildFragmentManager().beginTransaction()
          .replace(R.id.childFragmentContainer, new MviLifecycleChildFragment(), TAG)
          .commitNow();
    }
  ...
  public MviLifecycleChildFragment getChildFragment() {
    return (MviLifecycleChildFragment) getChildFragmentManager().findFragmentByTag(TAG);
  }
}
